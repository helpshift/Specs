Pod::Spec.new do |s|
  ...
  s.preserve_paths      = 'helpshift-sdk-ios-v5.6.1/libHelpshift-xcode6.a', 'helpshift-sdk-ios-v5.6.1/HSLocalization/*.lproj', 'helpshift-sdk-ios-v5.6.1/HSThemes/*.plist'
