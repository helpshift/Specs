Pod::Spec.new do |s|
  ...
  s.preserve_paths      = 'helpshift-sdk-ios-v5.6.2/libHelpshift-bitcode.a', 'helpshift-sdk-ios-v5.6.2/HSLocalization/*.lproj', 'helpshift-sdk-ios-v5.6.2/HSThemes/*.plist'
