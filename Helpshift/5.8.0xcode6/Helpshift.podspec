Pod::Spec.new do |s|
  ...
  s.source              = { :http => 'https://d3e51fp79zp4el.cloudfront.net/library/ios/v5.8/helpshift-sdk-ios-v5.8.0.zip', :type => :zip}
  s.platform            = :ios, '7.0'
  ...
  s.preserve_paths      = 'helpshift-sdk-ios-v5.8.0/libHelpshift-xcode6.a', 'helpshift-sdk-ios-v5.8.0/HsLocalization.bundle', 'helpshift-sdk-ios-v5.8.0/HSThemes/*.plist'
